...
<div class="page animsition">
    <div class="page-header">
        <h1 class="page-title">Form Tambah/Edit Pangkalan</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('home'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li><a href="<?php echo site_url('pangkalan'); ?>"><i class="fa fa-minus-circle"></i> Data Pangkalan</a>
            </li>
            <li class="active"><i class="fa fa-plus-circle"></i> Tambah/Edit Pangkalan</li>
        </ol>
    ...
    <div class="page-content">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Form Tambah/Edit Pangkalan</h3>
            </div>
            <div class="panel-body container-fluid">
                <form class="form-horizontal" action="<?php echo site_url('pangkalan/submit'); ?>" method="post">
                    <input type="hidden" name="action"
                           value="<?php echo isset($data['id_pangkalan']) ? 'edit' : 'add'; ?>">
                    <input type="hidden" name="id_pangkalan"
                           value="<?php echo isset($data['id_pangkalan']) ? $data['id_pangkalan'] : ''; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <?php if ($type_admin == 3): ?>
                                ...
                                <input type="hidden" class="form-control" name="id_agen" required=""
                                ...
                                <select name="id_agen" class="form-control">
                                    <?php if ($data_agen): ?>
                                        <?php foreach ($data_agen as $key): ?>
                                            <option
                                                value="<?php echo $key['id']; ?>" <?php echo (isset($data['id_agen']) && $key['id'] == $data['id_agen']) ? 'selected' : '' ?>><?php echo $key['name']; ?></option>
                                        <?php endforeach ?>
                                    <?php endif ?>
                                </select>
                            <?php endif; ?>
