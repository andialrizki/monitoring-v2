    ...
    <div class="container">
        ...
        <div class="panel panel-info">
          <div class="panel-heading">
            <strong>DATA PANGKALAN</strong>
            <a href="<?php echo site_url('pangkalan/add'); ?>" class="btn btn-primary btn-xs pull-right" style="margin-bottom: 15px;">
                  ...
                  <tbody>
                    ...
                    ?>
                            <tr>
                              ...
                              <td class="btn-action">
                                  <a href="<?php echo site_url('pangkalan/detail/'.$id); ?>" data-tooltip="tooltip" data-placement="top" title="Detail">
                                    <i class="fa fa-search"></i>
                                  </a>
                                  <a href="<?php echo site_url('pangkalan/edit/'.$id); ?>" data-tooltip="tooltip" data-placement="top" title="Edit">
