            ...
            <div class="panel-body">
              <form class="form-horizontal" action="<?php echo site_url('profile/submit'); ?>" method="post">
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <input type="text" class="form-control" name="no_registrasi" required="" value="<?php echo isset($data['no_registrasi']) ? $data['no_registrasi']:''; ?>" readonly>
                      </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <input type="text" class="form-control" name="sp_agen" required="" value="<?php echo isset($data['sp_agen']) ? $data['sp_agen']:''; ?>" readonly>
                      </div>
                  </div>
                  <div class="form-group">
