<div class="page animsition">
    <div class="page-header">
        <h1 class="page-title">Profil SPPBE</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('home'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li class="active"><i class="fa fa-plus-circle"></i>Profil SPPBE</a></li>
        </ol>
    ...
    <div class="page-content">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Profil SPPBE</h3>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <label
                                            class="control-label">: <?php echo isset($data['lokasi_spbe']) ? $data['lokasi_spbe'] : ''; ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
