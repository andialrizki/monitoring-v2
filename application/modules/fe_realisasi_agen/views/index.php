<div class="page animsition">
    <div class="page-header">
        <h1 class="page-title">Transaksi Agen</h1>
        <ol class="breadcrumb">
        ...
        <div class="page-header-actions">
            ...
            <a href="<?php echo site_url('realisasi-agen/add'); ?>" style="margin-bottom: 15px;">
    ...
    <div class="page-content">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Daftar Transaksi Agen</h3>
            </div>
                    ...
                    if (isset($data) && $data) :
                        foreach ($data as $key) :
                            ...
                            <tr>
                                ...
                                <td class="btn-action">
                                    <a href="<?php echo site_url('realisasi-agen/edit/' . $id); ?>"
