<section id="services">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-plus-circle"></i> Realisasi Agen</li>
        </ol>
        <?php if (isset($error)): ?>
        ...
        <div class="panel panel-info">
          <div class="panel-heading">
            ...
            <a href="<?php echo site_url('realisasi-agen/add'); ?>" class="btn btn-primary btn-xs pull-right" style="margin-bottom: 15px;">
                  ...
                  <tbody>
                    ...
                    ?>
                            <tr>
                              ...
                              <td class="btn-action">
                                  <a href="<?php echo site_url('realisasi-agen/edit/'.$id); ?>" data-tooltip="tooltip" data-placement="top" title="Edit">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form action="<?php echo site_url('realisasi-agen/del'); ?>" method="post">
