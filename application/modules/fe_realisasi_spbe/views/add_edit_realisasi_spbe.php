<section id="services">
    <div class="container">
      <ol class="breadcrumb">
          ...
          <li><a href="<?php echo site_url('realisasi-spbe'); ?>"><i class="fa fa-minus-circle"></i> Realisasi SPBE</a></li>
            ...
            <div class="panel-body">
              <form class="form-horizontal" action="<?php echo site_url('realisasi-spbe/submit'); ?>" method="post">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-7">
                          <input type="text" class="form-control" name="plant" required="" value="<?php echo isset($data['plant']) ? $data['plant']:''; ?>">
                      </div>
                  </div>
                  <div class="form-group">
