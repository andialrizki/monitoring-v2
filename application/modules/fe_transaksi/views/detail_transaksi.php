<section id="services">
    <div class="container">
      <ol class="breadcrumb">
          ...
          <li><a href="<?php echo site_url('pelanggan'); ?>"><i class="fa fa-minus-circle"></i> Pengecer</a></li>
          <li class="active"><i class="fa fa-plus-circle"></i> Detail Pengecer</li>
      </ol>
      <?php if (isset($error)): ?>
                  ...
                  <div class="col-xs-12">
                      <div class="col-sm-9">
                          <div class="form-group">
                              ...
                              <div class="col-sm-7">
                                  <label class="control-label">: <?php echo isset($pelanggan['id_pengecer']) ? $pelanggan['id_pengecer']:''; ?></label>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="control-label col-sm-3">Nama</label>
                              <div class="col-sm-7">
                                <label class="control-label">: <?php echo isset($pelanggan['name']) ? $pelanggan['name']:''; ?></label>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="control-label col-sm-3">Telepon</label>
                              <div class="col-sm-7">
                                  <label class="control-label">: <?php echo isset($pelanggan['phone']) ? $pelanggan['phone']:''; ?></label>
                              </div>
                          </div>
                          <div class="form-group">
                      ...
                      <div class="col-sm-3">
                          <img src="<?php echo base_url('assets/images'); ?>/qr_bkma_transaksi.png" class="img-responsive">
                      </div>
                  </div>
                  <div class="form-group">
                      <div class="col-sm-12">
